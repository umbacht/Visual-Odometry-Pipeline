...
%% Match Keypoints from previous and current image with KLT
    ...
    [F_hat, inliersIndex] = estimateFundamentalMatrix(tracked_keypoints_prv_norm(1:2,:)', tracked_keypoints_crt_norm(1:2,:)', 'Method',parameter.method, 'NumTrials', parameter.NumTrials, 'DistanceThreshold', parameter.DistanceThreshold);
    F_hat = T2.'* F_hat * T1; 
